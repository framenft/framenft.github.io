...
function Mint(props) {
    ...
    console.log(`contractInstance is ${contractInstance}, userSigner ${userSigner}, contract address ${ContractAddress}`);
    ...
    const whitelisted = useContractReader({ Frames: contractInstance }, "Frames", "wl", [address]);
            ...
            try {
                ...
                await tx(
                    userSigner.sendTransaction({
                        to: ContractAddress,
                        data: data,
                        value: whitelisted ? parseEther("0") : parseEther((0.02).toString())
            ...
            <div style={{ display: showModal ? "block" : "none", }} >
                <div style={{ backgroundColor: "antiquewhite", color: "black" }}>
                    ...
                    {!loading ?
                        (userSigner ?
                            <>
                                {whitelisted ? <p>WHITELISTED: Mint is Free ✅</p> : <></>}
